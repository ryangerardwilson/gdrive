...
def print_help_text() -> None:
    lines = [
        ...
        "  gdrive <preset> reg <local_dir> <drive_path>",
        "    register a local folder to sync into a Drive path",
        "  gdrive <preset> ls",
        "    list saved registrations for one preset",
        "  gdrive <preset> rm <edit_id>",
        "    remove one registration",
        "  gdrive run",
        "    sync all registrations across all presets",
        "  gdrive ti",
        "    install the hourly sync timer",
        "  gdrive td",
        "    disable the hourly sync timer",
        "  gdrive st",
        "    show timer status",
        "",
        "examples:",
